...
<div id="matrix_part" class="row question-box" <?php if(isset($display)): ?> style="display:<?php echo e($display); ?>;" <?php endif; ?>>
    ...
    <!-- Bilal Code -->
        <!-- <div class="col-12"> -->
            <!-- <?php  $matrixbox_header_color = '#282f79'; ?> -->
            ...
            <!-- <input type="color" class="matrixbox_header_color col-12" id="matrixbox_header_color" value="<?php echo e($matrixbox_header_color); ?>"> -->
        <!-- </div> -->
...
<?php /**PATH F:\laravel\resources\views/backend/questions/components/simple/matrix.blade.php ENDPATH**/ ?>