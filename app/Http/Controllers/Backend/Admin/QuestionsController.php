...
class QuestionsController extends Controller
{
    ...
    public function create()
    {
        ...
        if ( $question_count==0)
        {
            $question_infos="";
            $question_list="";
            $default = DB::table('defsetting')
                        ->first();
            return view('backend.questions.create')-> with('tests', $tests)-> with('default', $default)
        ...
        else
        {
            ...
            return view('backend.questions.create')->with('question_infos', $question_infos)->with('default', $default)->with('tests', $tests)
    ...
    public function store(Request  $request)
    {
            ...
            // );
            DB::table('defsetting')->where('id', '1')->update([
                'font_style' => $request->default_font_style,
                'font_family' => $request->default_font_family ?? '',
                'font_size' => $request->default_font_size ?? '',
                'font_color' => $request->default_font_color ?? '',
                'background_color' =>$request->default_background_color ?? '',
            ]);
            ...
            $last_id= DB::table('questions')->insertGetId([
                ...
                'image_alignment' => $request->image_alignment,
    ...
    public function edit($id)
    {
        ...
        $default = DB::table('defsetting')->first();
        ...
        ->with('default',$default)->with('course_list',$course_list)->with('course_test_list',$course_test_list)->with('test_list',$test_list)->with('question_list',$question_list)->with('question', $question)
