...
class Question extends Model
{
    ...
    'questionorder','width','indent','required','more_than_one_answer','fontsize','titlecolor','titlelocation','imagefit',
    'imagewidth','imageheight','columncount','content','logic','state','answer_alignment',
    'help_info_location','max_width','min_width','size'];
