                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-check">
                                    <input type="radio" name="required" id="required" placeholder="" class="form-check-input" value="1" @if($question->required==1) checked @endif/>
                                    {!! Form::label('required', 'Is Required', ['class' => 'form-check-label']) !!}
                                </div>
                                <div id="more_than_one_answer_box" class="form-check">
                                    <input type="radio" name="required" id="more_than_one_answer" placeholder="" class="form-check-input" value="1" @if($question->more_than_one_answer==1) checked @endif />
                                ...
                                <!-- {!! Form::label('title_size', 'Title Size', ['class' => 'control-label']) !!}
                                <input type="number" name="fontsize" id="fontsize" placeholder="" class="form-control" value="{{$question->font_size}}"/>

                                {!! Form::label('title_color', 'Title Color', ['class' => 'control-label']) !!}
                                <input type="color" name="titlecolor" id="title_color" placeholder="" class="form-control" value="{{$question->titlecolor}}"/> -->
                                ...
                                {!! Form::label('answer_alignment', 'Answer Aligment', ['class' => 'control-label']) !!}
                                <select class="form-control" name="options" id="answer_alignment" placeholder="Options">
                                    ...
                                    @endphp
                                    @foreach($answer_alignment as $key=>$value)
                                        <option value="{{$key}}" @if($question->answer_alignment==$key) selected @endif>{{$value}}</option>
                                    @endforeach
                                </select>
